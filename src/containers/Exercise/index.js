    ...
    return (
      <div className="exercise">
        <Row className="row-header">
          <Col>
            ...
            >
              ...
              <Row>
                <TextArea placeholder="Hướng dẫn (tùy chọn)" style={{marginBottom: 20}}
        ...
        <Row className="row-body">
          <Row className="element-exercise">
            ...
            <Col span={7} style={{textAlign: 'left'}}>
              <div>ABC</div>
              <div>Hạn 23:59, 5 thg 5</div>
            </Col>
            <Col span={9} offset={5}>
              <div style={{lineHeight: "40px"}}>Đã đăng vào 4 thg 3 (Đã chỉnh sửa 3 thg 5)</div>
            </Col>
            <Col span={1}>
